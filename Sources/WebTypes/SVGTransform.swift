...
public func matrix(_ a: Double, _ b: Double, _ c: Double, _ d: Double, _ e: Double, _ f: Double)
  -> SVGTransform
{
...
public func matrix(_ a: String, _ b: String, _ c: String, _ d: String, _ e: String, _ f: String)
  -> SVGTransform
{
  SVGTransform("matrix(\(a),\(b),\(c),\(d),\(e),\(f))")
}
