...
public func userScalable(_ value: HTMLMeta.Name.Viewport.Content.UserScalable)
  -> HTMLMeta.Name.Viewport.Content
{
  var vc = HTMLMeta.Name.Viewport.Content()
...
public func interactiveWidget(_ value: HTMLMeta.Name.Viewport.Content.InteractiveWidget)
  -> HTMLMeta.Name.Viewport.Content
{
  var vc = HTMLMeta.Name.Viewport.Content()
...
public func viewportFit(_ value: HTMLMeta.Name.Viewport.Content.ViewportFit)
  -> HTMLMeta.Name.Viewport.Content
{
  var vc = HTMLMeta.Name.Viewport.Content()
