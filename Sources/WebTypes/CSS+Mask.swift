...
extension CSS {
  public struct MaskLayer: Sendable {
    ...
    public let geometryBox: CSS.GeometryBox?
    ...
    public init(
      ...
      geometryBox: CSS.GeometryBox? = nil,
      clip: MaskClip? = nil,
...
public func maskLayer(
  _ reference: CSS.MaskLayer.MaskReference? = nil,
  position: CSS.MaskLayer.Position? = nil,
  size: CSS.MaskLayer.BgSize? = nil,
  repeatStyle: CSS.MaskLayer.RepeatStyle? = nil,
  geometryBox: CSS.GeometryBox? = nil,
  clip: CSS.MaskLayer.MaskClip? = nil,
  compositingOperator: CSS.MaskLayer.CompositingOperator? = nil,
  maskingMode: CSS.MaskLayer.MaskingMode? = nil
) -> CSS.MaskLayer {
  CSS.MaskLayer(
    reference: reference,
    position: position,
