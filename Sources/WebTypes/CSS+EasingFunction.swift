...
extension CSS {
  public enum EasingFunction: Sendable, CSSVariableConvertible {
...
extension CSS.EasingFunction {
  public static var linear: CSS.EasingFunction {
    .linear(.linear)
  }

  public static var ease: CSS.EasingFunction {
    .cubicBezier(.ease)
  }

  public static var easeIn: CSS.EasingFunction {
    .cubicBezier(.easeIn)
  }

  public static var easeOut: CSS.EasingFunction {
    .cubicBezier(.easeOut)
  }

  public static var easeInOut: CSS.EasingFunction {
    .cubicBezier(.easeInOut)
  }

  public static var stepStart: CSS.EasingFunction {
    .step(.stepStart)
  }

  public static var stepEnd: CSS.EasingFunction {
    .step(.stepEnd)
  }
  ...
  public static func steps(_ count: Int, _ position: CSS.StepPosition? = nil) -> CSS.EasingFunction {
