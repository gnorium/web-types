...
extension CSS {
  public struct FontFamily: Sendable, CSSVariableConvertible, CustomStringConvertible, ExpressibleByStringLiteral, ExpressibleByStringInterpolation
  {
    ...
    public static func variable(_ name: String) -> FontFamily {
      FontFamily("var(\(name))")
    }

    public init(_ font1: FontFamily, _ font2: FontFamily) {
      self.value = "\(font1.value), \(font2.value)"
    }

    public init(_ font1: FontFamily, _ font2: FontFamily, _ font3: FontFamily) {
      self.value = "\(font1.value), \(font2.value), \(font3.value)"
    }

    public init(
      _ font1: FontFamily, _ font2: FontFamily, _ font3: FontFamily,
      _ font4: FontFamily
    ) {
