...
public enum CSSImage: Sendable {
  ...
  public enum Gradient: Sendable {
    ...
    public struct RadialGradient: Sendable {
      ...
      public init(
        shape: RadialShape? = nil, size: RadialSize? = nil, position: CSSMaskLayer.Position? = nil,
    ...
    public struct ConicGradient: Sendable {
      ...
      public init(
        from angle: CSSAngle? = nil, at position: CSSMaskLayer.Position? = nil,
        colorStops: [ColorStop]
      ) {
        self.angle = angle
        self.position = position
...
public func linearGradient(
  to direction: CSSGradientDirection, _ first: (CSSColor, Percentage),
  _ rest: (CSSColor, Percentage)...
) -> CSSImage.Gradient {
...
// Linear gradient
public func linearGradient(
  to direction: CSSGradientDirection, _ first: CSSColor, _ rest: CSSColor...
) -> CSSImage.Gradient {
...
public func linearGradient(
  _ angle: CSSAngle, _ first: (CSSColor, Percentage), _ rest: (CSSColor, Percentage)...
) -> CSSImage.Gradient {
  var stops = [CSSImage.Gradient.ColorStop(first.0, first.1)]
  stops.append(contentsOf: rest.map { CSSImage.Gradient.ColorStop($0.0, $0.1) })
...
// Linear gradient with angle
public func linearGradient(_ angle: CSSAngle, _ first: CSSColor, _ rest: CSSColor...)
  -> CSSImage.Gradient
{
  var stops = [CSSImage.Gradient.ColorStop(first)]
  stops.append(contentsOf: rest.map { CSSImage.Gradient.ColorStop($0) })
...
public func radialGradient(
  _ shape: CSSImage.Gradient.RadialShape, at position: CSSMaskLayer.Position? = nil,
  _ first: (CSSColor, Percentage), _ rest: (CSSColor, Percentage)...
) -> CSSImage.Gradient {
  var stops = [CSSImage.Gradient.ColorStop(first.0, first.1)]
  stops.append(contentsOf: rest.map { CSSImage.Gradient.ColorStop($0.0, $0.1) })
  return .radial(
    CSSImage.Gradient.RadialGradient(shape: shape, size: nil, position: position, colorStops: stops)
  )
}
...
public func radialGradient(
  _ shape: CSSImage.Gradient.RadialShape, at position: CSSMaskLayer.Position? = nil,
  _ first: CSSColor, _ rest: CSSColor...
) -> CSSImage.Gradient {
  var stops = [CSSImage.Gradient.ColorStop(first)]
  stops.append(contentsOf: rest.map { CSSImage.Gradient.ColorStop($0) })
  return .radial(
...
public func conicGradient(
  from angle: CSSAngle? = nil, at position: CSSMaskLayer.Position? = nil,
  _ stops: (CSSColor, CSSColor)
) -> CSSImage.Gradient {
  .conic(
    CSSImage.Gradient.ConicGradient(
...
public func conicGradient(
  from angle: CSSAngle? = nil, at position: CSSMaskLayer.Position? = nil,
  _ stops: (CSSColor, CSSColor, CSSColor)
) -> CSSImage.Gradient {
  .conic(
    CSSImage.Gradient.ConicGradient(
      from: angle, at: position,
...
public func conicGradient(
  from angle: CSSAngle? = nil, at position: CSSMaskLayer.Position? = nil,
  _ stops: (CSSColor, CSSColor, CSSColor, CSSColor)
) -> CSSImage.Gradient {
  .conic(
    CSSImage.Gradient.ConicGradient(
      from: angle, at: position,
